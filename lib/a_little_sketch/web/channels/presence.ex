defmodule ALittleSketch.Web.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ALittleSketch.MyChannel do
        use ALittleSketch.Web, :channel
        alias ALittleSketch.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :a_little_sketch,
                        pubsub_server: ALittleSketch.PubSub
end
